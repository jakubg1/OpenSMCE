...
---
---**NOTE:**
---Currently, the Game class constructs the Sprite Atlases. They are not stored anywhere collectively, as storing them is not needed,
---although in the future the Resource Manager will take care of this.
---
---**NOTE:**
