...
function PathEntityConfig:new(data, path, isAnonymous, base)
    ...
    self.spriteLayer = u.parseStringOpt(data, base, path, {"spriteLayer"}, "GamePieceNormal")
    self.spriteHiddenLayer = u.parseStringOpt(data, base, path, {"spriteHiddenLayer"}, "GamePieceHidden")
    self.shadowSprite = u.parseSpriteOpt(data, base, path, {"shadowSprite"})
    self.shadowSpriteLayer = u.parseStringOpt(data, base, path, {"shadowSpriteLayer"}, "GamePieceNShadow")
    self.shadowSpriteHiddenLayer = u.parseStringOpt(data, base, path, {"shadowSpriteHiddenLayer"}, "GamePieceHShadow")
    ...
    self.particleLayer = u.parseStringOpt(data, base, path, {"particleLayer"}, "GamePieceNormal")
    self.particleHiddenLayer = u.parseStringOpt(data, base, path, {"particleHiddenLayer"}, "GamePieceHidden")
