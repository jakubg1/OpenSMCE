...
function PathEntityConfig:new(data, path)
    ...
    self.collectibleGenerator = u.parseCollectibleGeneratorOpt(data.collectibleGenerator, path, "collectibleGenerator")
    ...
    self.destroyScoreEvent = u.parseScoreEventOpt(data.destroyScoreEvent, path, "destroyScoreEvent")
    self.destroyCollectibleGenerator = u.parseCollectibleGeneratorOpt(data.destroyCollectibleGenerator, path, "destroyCollectibleGenerator")
    ...
    self.sphereDestroyScoreEvent = u.parseScoreEventOpt(data.sphereDestroyScoreEvent, path, "sphereDestroyScoreEvent")
