...
function PathEntityConfig:new(data, path, isAnonymous, base)
    ...
    self.spriteLayer = u.parseString(data, base, path, {"spriteLayer"}, "GamePieceNormal")
    self.spriteHiddenLayer = u.parseString(data, base, path, {"spriteHiddenLayer"}, "GamePieceHidden")
    self.shadowSprite = u.parseSpriteOpt(data, base, path, {"shadowSprite"})
    self.shadowSpriteLayer = u.parseString(data, base, path, {"shadowSpriteLayer"}, "GamePieceNShadow")
    self.shadowSpriteHiddenLayer = u.parseString(data, base, path, {"shadowSpriteHiddenLayer"}, "GamePieceHShadow")
    ---@type "start"|"end"|"furthestSpheres"
    self.spawnPlacement = u.parseString(data, base, path, {"spawnPlacement"})
    self.spawnOffset = u.parseNumber(data, base, path, {"spawnOffset"}, 0)
    self.speed = u.parseNumber(data, base, path, {"speed"})
    self.acceleration = u.parseNumber(data, base, path, {"acceleration"}, 0)
    ...
    self.particleLayer = u.parseString(data, base, path, {"particleLayer"}, "GamePieceNormal")
    self.particleHiddenLayer = u.parseString(data, base, path, {"particleHiddenLayer"}, "GamePieceHidden")
