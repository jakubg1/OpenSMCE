...
function LevelConfig:new(data, path, isAnonymous, base)
    ...
    self.music = u.parseMusicPlaylist(data, base, path, {"music"})
    self.dangerMusic = u.parseMusicPlaylistOpt(data, base, path, {"dangerMusic"})
    self.ambientMusic = u.parseMusicTrackOpt(data, base, path, {"ambientMusic"})
