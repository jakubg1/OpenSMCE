...
function ParticleConfig:new(data, path, isAnonymous, base)
    ...
    self.animationFrameCount = u.parseIntegerOpt(data, base, path, {"animationFrameCount"})
    ...
    self.fadeTime = u.parseExprNumberOpt(data, base, path, {"fadeTime"})
    self.fadeInPoint = u.parseNumberOpt(data, base, path, {"fadeInPoint"})
    self.fadeOutPoint = u.parseNumberOpt(data, base, path, {"fadeOutPoint"})
    self.posRelative = u.parseBoolean(data, base, path, {"posRelative"}, false)
