...
---@param node UIWidget|UI2Node? The UI node/widget of which the tree should be generated. Leaving this parameter out will generate data for the entire UI tree.
