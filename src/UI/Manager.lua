...
function UIManager:new()
  ...
  self.scriptFunctions = {
    ...
    profileNewGame = function(checkpoint, difficulty) _Game:getCurrentProfile():newGame(checkpoint, _Game.resourceManager:getDifficultyConfig(difficulty)) end,
    ...
    profileGetLives = function() return _Game:getCurrentProfile():getSession():getLives() end,
    profileGetCoins = function() return _Game:getCurrentProfile():getSession():getCoins() end,
    profileGetScore = function() return _Game:getCurrentProfile():getSession():getScore() end,
    profileGetSession = function() return _Game:getCurrentProfile():getSession() end,
    profileGetLevel = function() return _Game:getCurrentProfile():getTotalLevel() end,
    profileGetLevelData = function() return _Game:getCurrentProfile():getLevelData() end,
    ...
    configGetLevelData = function(n) return _Game:getCurrentProfile().levelSetConfig.levelOrder[n].level end,
